...
public class DJBZroVerificationController {
	...
	public DJBZroVerificationController(ResponseInfoFactory responseInfoFactory,
			ZroVerificationService zroVerificationService, DJBZroVerificationInboxService inboxService,
			DJBMonthlyBillingFetchService billingFetchService, WaterBillingCycleDao billingCycleDao,
	 ...
	 * with the current billing-cycle/ZRO state. No calculation or billing side
	 * effect.
	 */
	...
	public ResponseEntity<DJBZroVerificationFetchResponse> fetch(
		...
		if (verification == null) {
			throw new IllegalArgumentException(
					"ZRO verification not found for billing cycle: " + request.getBillingCycleId());
		}

		org.egov.wscalculation.djbmonthlybilling.web.model.DJBMonthlyBillingFetchRequest billingRequest = new org.egov.wscalculation.djbmonthlybilling.web.model.DJBMonthlyBillingFetchRequest();
		...
		DJBZroVerificationFetchResponse response = DJBZroVerificationFetchResponse.builder()
				...
				.verification(verification).billingCycle(cycle)
				.billingStatement(statementResponse.getBillingStatement()).build();
		return new ResponseEntity<>(response, HttpStatus.OK);
	}
