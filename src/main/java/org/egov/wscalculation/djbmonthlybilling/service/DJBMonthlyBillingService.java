...
public class DJBMonthlyBillingService {
    ...
    public DJBMonthlyBillingService(
            BillingBasisService billingBasisService,
            ConsumptionService consumptionService) {
        this.billingBasisService = billingBasisService;
        this.consumptionService = consumptionService;
    }

    public ConsumptionResult determineConsumption(
            String tenantId,
            String connectionNo,
            WaterBillingCycle currentCycle,
        ...
        return determineCycle(
                ...
                currentCycle,
                rqc,
                rule).getConsumptionResult();
    }

    public MonthlyBillingCalculationResult determineCycle(
            String tenantId,
            String connectionNo,
            WaterBillingCycle currentCycle,
            DJBReadingQualityCode rqc,
        ...
        BillingBasisDecision decision =
                billingBasisService.determineBillingBasis(
                        tenantId,
                        connectionNo,
                        currentCycle,
                        rqc,
        ...
        return MonthlyBillingCalculationResult.builder()
                .billingBasisDecision(decision)
                .consumptionResult(consumption)
                .build();
    }
